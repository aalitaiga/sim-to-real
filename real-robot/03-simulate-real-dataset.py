...
for run in ["train", "test"]:
    ...
    ds = np.load(os.path.expanduser("~/data/sim2real/dataset-real-{}-normalized-onlyRobot.npz".format(run)))
    ...
    np.savez(os.path.expanduser("~/data/sim2real/dataset-real-{}-normalized-bullet.npz".format(run)),
