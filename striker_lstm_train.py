...
max_steps = int(sys.argv[1]) or 5000
...
MODEL_PATH = "./trained_models/lstm_striker_{}l_{}_d{}_{}.pt".format(
    LSTM_LAYERS,
    HIDDEN_NODES,
    dropout,
    max_steps
)
MODEL_PATH_BEST = "./trained_models/lstm_striker_{}l_{}_d{}_{}_best.pt".format(
    LSTM_LAYERS,
    HIDDEN_NODES,
    dropout,
    max_steps
