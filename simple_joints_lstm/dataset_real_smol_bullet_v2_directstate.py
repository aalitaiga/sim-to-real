...
class DatasetRealSmolBulletV3DirectState(Dataset):
...
if __name__ == '__main__':
    dsr = DatasetRealSmolBulletV3DirectState(train=False)
    print("len test", len(dsr))

    print(dsr[10])

    dsr = DatasetRealSmolBulletV3DirectState(train=True)
    ...
    for i in range(10,20):
        ...
        print("real t2:", dsr[0]["y"][i].round(2))
        print("===")
