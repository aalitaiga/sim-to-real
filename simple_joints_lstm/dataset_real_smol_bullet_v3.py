...
class DatasetRealSmolBulletV3(Dataset):
    def __init__(self, path="~/data/sim2real/data-realigned-v4-{}-bullet.npz", train=True):
        super().__init__()
...
if __name__ == '__main__':
    dsr = DatasetRealSmolBulletV3(train=False)
    print("len test", len(dsr))

    print(dsr[10])

    dsr = DatasetRealSmolBulletV3(train=True)
