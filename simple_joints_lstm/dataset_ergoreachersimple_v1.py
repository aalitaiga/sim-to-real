...
class DatasetErgoreachersimpleV1(Dataset):
    def __init__(self, path="~/data/sim2real/data-ergoreachersimple-v1.npz", train=True):
        super().__init__()
...
if __name__ == '__main__':
    dsr = DatasetErgorechersimpleV1(train=False)
    print("len test", len(dsr))

    print(dsr[10])

    dsr = DatasetErgorechersimpleV1(train=True)
